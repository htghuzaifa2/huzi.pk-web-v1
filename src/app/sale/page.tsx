                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8 border-b border-white/5 pb-10">
                    <div>
                        ...
                        <p className="text-gray-500 text-lg">
                            Displaying <span className="text-white font-mono">{finalSaleList.length}</span> items. Next refresh in... whenever you click refresh.
                        </p>
                    </div>
                    <Button
                        variant="outline"
                                ...
                                <div className={`relative transition-all duration-500 hover:-translate-y-2 ${isFlash ? '' : ''}`}>
                                    ...
                                    `}>
                                        <div className="relative">
                                            {/* We can't easily inject into ProductCard, but we can wrap it. 
                                                If ProductCard has a white background, it might clash.
                                                Assuming ProductCard is transparent or adaptable. 
                                                If it has bg-card, we might need a wrapper to override or just accept it.
                                            */}
